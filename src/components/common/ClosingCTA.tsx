...
const PAGE_CONFIGS: Record<string, CTAConfig> = {
  '/academy': {
    ...
    muted: ['need', 'to', 'learn.'],
    description: 'Standard programmes, or fully customised to your duration, modules, format, and team size.',
  ...
  '/solutions': {
    ...
    description: 'Every build starts with a short, honest conversation about your operations — not a demo of ours.',
  ...
  '/about': {
    ...
    muted: ['to', 'help', 'you?'],
    description: "Tell us what you're building and where it slows down. We'll tell you honestly whether AI is the right fix.",
    primaryBtn: { text: 'Book a consultation', href: '/consultation' },
    secondaryBtn: { text: 'See what we build', href: '/solutions' }
  },
  '/blog': {
    ...
    description: "Let's discuss your workflows and build custom automation that moves your business forward.",
    primaryBtn: { text: 'Book a consultation', href: '/consultation' },
    secondaryBtn: { text: 'See what we build', href: '/solutions' }
  },
  '/consultation': {
    ...
    description: 'Learn more about how our custom AI systems remove operational drag, or browse our latest field notes and articles.',
