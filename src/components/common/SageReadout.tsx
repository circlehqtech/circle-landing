...
/**
 * Circle: a passive observer that surfaces ONCE, as a non-blocking coach mark
 * pinned to the bottom of the viewport. The page stays fully usable throughout.
 */
export function CircleReadout() {
        ...
        {phase === "tip" ? (
          ...
          >
            ...
            <p className="flex-1 text-[13px] leading-snug text-white/90">
              <span className="font-medium">Circle</span> has been reading this
              session.
          ...
          <motion.section
            ...
            aria-label="Circle behavioural readout"
...
function Metric({
  ...
  return (
    <div className="bg-hq-black p-3.5">
      ...
      <dt className="mt-1 font-mono text-[9px] uppercase tracking-widest text-hq-mute">
        {label}
      </dt>
    </div>
  );
