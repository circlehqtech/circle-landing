...
const LIGHT_PAGES = ['/about', '/academy', '/blog'];
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`rounded-full border p-2 md:hidden ${
              isLightPage ? 'border-hq-ink/20 text-hq-ink' : 'border-hq-line text-white'
            }`}>
        ...
        {open && (
          <motion.div
            ...
            className={`overflow-hidden border-t md:hidden ${
              isLightPage ? 'border-hq-ink/10 bg-hq-bone text-hq-ink' : 'border-hq-line bg-hq-black text-white'
            }`}>
                ...
                <li key={link.label}>
                  <Link
                    ...
                    className={`block border-b py-3 text-sm ${
                      isLightPage ? 'border-hq-ink/10 text-hq-ink/80' : 'border-hq-line/60 text-hq-mute'
                    }`}>
                    {link.label}
                  </Link>
                </li>
