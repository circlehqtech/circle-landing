...
const STATS = [
  ...
  { value: 100, suffix: "%", label: "Customized to fit your business" },
];
        ...
        <div className="grid gap-14 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="lg:sticky lg:top-28 lg:self-start">
            ...
            <p className="mt-6 max-w-md text-sm leading-relaxed text-hq-mute">
              We build durable AI infrastructure and workforce capability for
              companies ready to operate smarter.
            </p>
