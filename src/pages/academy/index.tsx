...
import { ArrowRightIcon, DownloadIcon, HeartIcon, CameraIcon, Building2Icon, UserIcon, CheckIcon, GraduationCapIcon, WifiOffIcon } from 'lucide-react';
...
const BUSINESS_TOPICS = [
  ...
  'AI tools for daily productivity — ChatGPT, Copilot, and Gemini',
...
const ROW_TWO: Shot[] = [
  {
    ...
    label: '1-on-1 Portfolio Mentorship'
  },
  {
    src: "/9676547c-bb5b-49a6-b12f-91640f0ea60b.jpg",
    label: 'Graduation & Job Fair'
  },
  {
    src: "/2716ccb6-35bb-43e3-b2b5-908f2d8c7302.jpg",
    label: 'Peer Build Sprint'
  },
  {
    src: "/0ebc1652-0ca4-4ab7-93ef-92e86aa33b02.jpg",
    label: 'Workflow Automation Workshop'
  }
];

const ROW_THREE: Shot[] = [
  {
    src: "/3d6765c2-4e61-4a52-9189-9e5cc900abba.jpg",
    label: 'Certificate Presentations'
  },
  {
  ...
  {
    src: "/blog_ai_solutions_sphere.png",
    label: 'AI Tools Demonstration'
  }
];
...
export function AcademyPage() {
  ...
  return (
    <div className="relative bg-hq-bone text-hq-ink min-h-screen">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-5 sm:px-8">
          <div className="max-w-4xl">
            ...
            <motion.p
              ...
              Practical AI education for Nigerian professionals and organisations — from teams learning to work alongside AI, to individuals learning to build with it. Real tools. Real outcomes. Built for the Nigerian market.
            </motion.p>

            <div className="mt-8 flex flex-wrap gap-4">
              <MagneticButton href="/consultation" className="inline-flex items-center gap-2 rounded-full bg-hq-red px-6 py-3.5 text-sm font-medium text-white shadow-md hover:bg-hq-red-deep">
        ...
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
          ...
          <div className="mb-14">
            ...
            <h2 className="font-display text-4xl sm:text-6xl font-semibold leading-[1.05] tracking-[-0.03em] text-white max-w-3xl">
              Understand AI, <span className="text-hq-mute">or learn to build with it.</span>
            </h2>
            <p className="text-hq-mute text-base sm:text-lg leading-relaxed mt-4 max-w-3xl">
              Whether your organisation wants staff who understand and use AI more effectively, or you're an individual who wants to build AI systems professionally — Circle Academy has a structured path for both.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="rounded-3xl border border-white/10 bg-[#0e0e11] p-6 sm:p-8 flex flex-col justify-between shadow-2xl">
              <div>
                ...
                <p className="text-sm leading-relaxed text-hq-mute mt-4">
                  For organisations that want their teams working more effectively alongside AI — understanding how to use it responsibly, safely, and strategically. Not a technical course: a business and behavioural programme for staff at any level.
                </p>

                {/* Specs Table */}
                <div className="border-t border-b border-white/10 py-4 my-6 space-y-3 font-mono text-xs">
                  <div className="flex justify-between items-center gap-2">
                    <span className="text-hq-mute uppercase tracking-wider text-[10px]">DURATION</span>
                    <span className="text-white font-semibold text-right">1 week (5 intensive days)</span>
                  </div>
                  <div className="flex justify-between items-center gap-2">
                    <span className="text-hq-mute uppercase tracking-wider text-[10px]">FORMATS</span>
                    <span className="text-white font-semibold text-right">Physical (on-site) or online live sessions</span>
                  </div>
                  <div className="flex justify-between items-center gap-2">
                    <span className="text-hq-mute uppercase tracking-wider text-[10px]">GROUP SIZE</span>
                    <span className="text-white font-semibold text-right">Minimum 5 staff · custom for larger teams</span>
                  </div>
                </div>
                ...
                <ul className="space-y-3 text-sm text-white/90 mb-6">
                  {BUSINESS_TOPICS.map((topic, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <CheckIcon size={16} className="text-hq-red shrink-0 mt-0.5" />
                      <span>{topic}</span>
                    </li>
                  ))}
                </ul>
              ...
              <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-xs italic text-hq-mute">
                This is our standard offering. If your needs differ — duration, modules, format, or team size — we're open to full customisation. Speak to us before booking.
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-[#0e0e11] p-6 sm:p-8 flex flex-col justify-between shadow-2xl">
              <div>
                ...
                <p className="text-sm leading-relaxed text-hq-mute mt-4">
                  Takes participants from zero to functional AI agent builders — capable of designing and deploying real automation workflows using tools like Make, Zapier, and n8n.
                </p>

                {/* Specs Table */}
                <div className="border-t border-b border-white/10 py-4 my-6 space-y-3 font-mono text-xs">
                  <div className="flex justify-between items-center gap-2">
                    <span className="text-hq-mute uppercase tracking-wider text-[10px]">FORMAT</span>
                    <span className="text-white font-semibold text-right">Online, live + self-paced modules</span>
                  </div>
                  <div className="flex justify-between items-center gap-2">
                    <span className="text-hq-mute uppercase tracking-wider text-[10px]">COHORT SIZE</span>
                    <span className="text-white font-semibold text-right">Minimum 20 per cohort, rolling enrolment</span>
                  </div>
                  <div className="flex justify-between items-center gap-2">
                    <span className="text-hq-mute uppercase tracking-wider text-[10px]">PRACTICALS</span>
                    <span className="text-white font-semibold text-right">3 real agent builds per participant</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-sm text-white/90 mb-6">
                    <li className="flex items-start gap-3">
                      <CheckIcon size={16} className="text-hq-red shrink-0 mt-0.5" />
                      <span>Build a WhatsApp or email auto-response workflow — no code required.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckIcon size={16} className="text-hq-red shrink-0 mt-0.5" />
                      <span>Build a functional lead capture and CRM automation connected to a real business workflow.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckIcon size={16} className="text-hq-red shrink-0 mt-0.5" />
                      <span>Design and deploy a complete AI agent handling a real business process end-to-end, with a portfolio of builds ready for client or employer use.</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="rounded-xl border border-red-500/30 bg-red-950/20 p-4 text-xs font-medium text-white/90 mb-4">
                  Every cohort ends with a graduation ceremony that doubles as a job fair — giving organisations a direct route to hire from a pool of AI-ready graduates.
                </div>
      ...
      <section id="free-programmes" className="bg-[#eee9e0] py-20 sm:py-28 border-b border-hq-ink/10">
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
            ...
            <div>
              ...
              <h2 className="mt-6 max-w-md font-display text-4xl font-semibold leading-[1.05] tracking-[-0.03em] text-hq-ink sm:text-5xl">
                AI readiness shouldn't depend on <span className="text-hq-red">who can afford it.</span>
              </h2>

              <p className="mt-6 max-w-md text-sm leading-relaxed text-hq-ink/75">
                Circle Academy runs free AI literacy training for secondary school students and university students across Nigeria — no fees, no catch.
              </p>
            ...
            <div className="space-y-4">
              ...
              <div
                ...
                <div
                  className={`absolute inset-0 translate-x-1.5 translate-y-1.5 rounded-2xl bg-hq-red transition-all duration-200 ${
                    activeProgramCard === 0 ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                  }`}
                />
                <div
                  ...
                  <div
                    className={`h-10 w-10 shrink-0 rounded-full text-white flex items-center justify-center transition-colors duration-200 ${
                      activeProgramCard === 0 ? 'bg-hq-red shadow-sm' : 'bg-[#070708] group-hover:bg-hq-red'
                    }`}>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-relaxed text-hq-ink/75">
                      Free AI literacy training aligned to Nigeria's NERDC Digital Technologies curriculum.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div
                ...
                <div
                  className={`absolute inset-0 translate-x-1.5 translate-y-1.5 rounded-2xl bg-hq-red transition-all duration-200 ${
                    activeProgramCard === 1 ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                  }`}
                />
                <div
                  className={`relative flex items-center gap-4 rounded-2xl border border-hq-ink/15 p-5 sm:p-6 shadow-sm transition-all duration-200 ${
                  ...
                  <div
                    className={`h-10 w-10 shrink-0 rounded-full text-white flex items-center justify-center transition-colors duration-200 ${
                      activeProgramCard === 1 ? 'bg-hq-red shadow-sm' : 'bg-[#070708] group-hover:bg-hq-red'
                    }`}>
                    <HeartIcon size={18} />
                  </div>
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-relaxed text-hq-ink/75">
                      Extended sessions for undergraduates preparing to enter an AI-shaped job market.
                    </p>
                  </div>
                </div>
              </div>

              {/* Card 3: Phone-first, offline-friendly */}
              <div
                className="group relative cursor-pointer"
                onMouseEnter={() => setActiveProgramCard(2)}>
                <div
                  className={`absolute inset-0 translate-x-1.5 translate-y-1.5 rounded-2xl bg-hq-red transition-all duration-200 ${
                    activeProgramCard === 2 ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                  }`}
                />
                <div
                  className={`relative flex items-center gap-4 rounded-2xl border border-hq-ink/15 p-5 sm:p-6 shadow-sm transition-all duration-200 ${
                  ...
                  <div
                    className={`h-10 w-10 shrink-0 rounded-full text-white flex items-center justify-center transition-colors duration-200 ${
                      activeProgramCard === 2 ? 'bg-hq-red shadow-sm' : 'bg-[#070708] group-hover:bg-hq-red'
                    }`}>
                    <WifiOffIcon size={18} />
                  </div>
                  <div>
                    <h3 className="font-display text-base sm:text-lg font-semibold text-hq-ink">
                      Phone-first, offline-friendly
                    </h3>
                    <p className="mt-1 text-xs leading-relaxed text-hq-ink/75">
                      Designed for phone-first access with offline backup options, so bandwidth is never the barrier.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 text-center">
        <div className="mx-auto max-w-3xl px-5 sm:px-8">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <MagneticButton href="mailto:hello@circlehq.co?subject=Program%20Outline%20Request" strength={0.25} className="inline-flex items-center gap-2 rounded-full border border-hq-ink/20 bg-white px-6 py-3.5 text-sm text-hq-ink hover:border-hq-red hover:text-hq-red transition-colors shadow-sm">
